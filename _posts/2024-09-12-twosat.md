...
<div class="jsfiddle-twosat">
    <script async src="//jsfiddle.net/nima101/o5fj6snb/92/embed/result/dark/"></script>
</div>

[http://jsfiddle.net/nim_a101/o5fj6snb/92/](http://jsfiddle.net/nim_a101/o5fj6snb/92/)
...
In order to find all SCCs of a graph we can utilize [Kosaraju's Algorithm](https://www.topcoder.            
com/thrive/articles/kosarajus-algorithm-for-strongly-connected-components). In short, the algorithm is as follows:
